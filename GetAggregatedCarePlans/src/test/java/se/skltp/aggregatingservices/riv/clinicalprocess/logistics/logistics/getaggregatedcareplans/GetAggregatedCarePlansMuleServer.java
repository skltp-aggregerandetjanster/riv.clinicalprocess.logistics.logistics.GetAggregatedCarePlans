...
public class GetAggregatedCarePlansMuleServer {

    public static final String MULE_SERVER_ID = "GetAggregatedCarePlans";

    private static final Logger logger = LoggerFactory.getLogger(GetAggregatedCarePlansMuleServer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedCarePlans-common.xml"
        //
