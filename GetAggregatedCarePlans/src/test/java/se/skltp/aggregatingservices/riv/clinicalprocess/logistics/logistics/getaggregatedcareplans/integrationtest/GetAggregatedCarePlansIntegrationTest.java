...
public class GetAggregatedCarePlansIntegrationTest extends AbstractAggregateIntegrationTest {
    ...
    public GetAggregatedCarePlansIntegrationTest() {
    ...
    private List<ProcessingStatusRecordType> doTest(String registeredResidentId, String senderId, String originalConsumerHsaId, String correlationId, int expectedProcessingStatusSize, TestData... testData) {
        ...
        GetAggregatedCarePlansTestConsumer consumer = new GetAggregatedCarePlansTestConsumer(DEFAULT_SERVICE_ADDRESS, senderId ,originalConsumerHsaId, correlationId);
        ...
        for (int i = 0; i < testData.length; i++) {
            final CarePlanType responseElement = response.getCarePlan().get(i);
